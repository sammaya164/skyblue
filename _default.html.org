...
<head>
	...
	<link rel="stylesheet" href="{{ site.baseurl }}/assets/css/atom-one-light.css">
...
<body>
	{{ "/assets/css/atom-one-light.css" | relative_url }}
	...
	<div class="wrapper">
		...
		<div class="tag_list">
			...
			<ul>
				...
				{% for tag in tags %}
				<li><a href="{{ site.baseurl }}/tag/{{ tag | first | slugify }}/" title="{{ tag[0] | replace:'-', ' ' }}"><img src="{{ site.baseurl }}/assets/img/folder.ico" />{{ tag[0] | replace:'-', ' ' }}</a></li>
				{% endfor %}
			</ul>
				</li>
			</ul>
	...
	<div class="footer">
		<p>{{ site.name }}. Powered by <a href="https://jekyllrb.com/" target="_blank">Jekyll</a> and <a href="http://github.com/h01000110/windows-95" target="_blank">windows-95</a>.</p>
	</div>
</body>
</html>
